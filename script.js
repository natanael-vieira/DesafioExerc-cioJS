...
var game = {
    ...
    listen: function () {
        document.addEventListener('keydown', function (key) {
            ...
            //if (key.KeyBoardEvent.code === 38 || key.KeyboardEvent.code === 87) pong.player.move = directions.UP; // Essa versão é a mais recente, mas nem todos os navegadores a reconhecem ainda, por isso estamos utilizando o antigo.

            // controla os eventos de input para baixo e S
            if (key.keyCode === 40 || key.keyCode === 83) pong.player.move = directions.DOWN;
            //if (key.KeyboardEvent.code === 40 || key.KeyboardEvent.code === 83) pong.player.move = directions.DOWN; //
        });
